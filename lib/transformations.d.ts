 ...
 */
export declare function flatMap<T, U>(option: Option<T>, fn: (value: T) => Option<U>): Option<U>;
/**
 ...
 */
export declare function liftA2<T, U, V>(fn: (t: T, u: U) => V, option1: Option<T>, option2: Option<U>): Option<V>;
/**
 ...
 */
export declare function matchOption<T, U>(option: Option<T>, onSome: (value: T) => Option<U>, onNone: () => Option<U>): Option<U>;
/**
 ...
 */
export declare function and<T, U>(option1: Option<T>, option2: Option<U>): Option<[T, U]>;
/**
 ...
 */
export declare function or<T>(option1: Option<T>, option2: Option<T>): Option<T>;
